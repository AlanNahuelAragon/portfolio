...
export const Contact = () => {
  ...
  const sendEmail = (event) => {
    ...
    emailjs.sendForm(`${import.meta.env.VITE_EMAILJS_SERVICE_ID}`, `${import.meta.env.VITE_EMAILJS_TEMPLATE_ID}`, event.target, `${import.meta.env.VITE_EMAILJS_PUBLIC_KEY}`)
      .then(response => {
